...
public final class String {
    ...
    public String substring(final int beginIndex) {
        ...
        final int subLen = value.length - beginIndex;
        if (subLen < 0) throw new StringIndexOutOfBoundsException(subLen);

        return (beginIndex == 0) ? this : new String(beginIndex, subLen, this.value);
    }
    ...
    public String substring(final int beginIndex, final int endIndex) {
        ...
        return ((beginIndex == 0) && (endIndex == this.value.length)) ? this : new String(beginIndex, subLen, this.value);
    }
}